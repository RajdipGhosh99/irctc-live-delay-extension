 ...
 * Interactive [🚆 Check ↻] pill button with reactive state machine
...
export class BadgeComponent {
  ...
  public static createBadgeButton(trainNumber: string): HTMLElement {
    ...
    badge.innerHTML = `
      <span class="rail-badge-text">🚆 Check</span>
      <span class="rail-badge-reload-icon" title="Fetch live running delay">↻</span>
    `;
    return badge;
  }
  ...
  public static updateState(
    ...
    if (state === 'loading') {
      ...
      badge.innerHTML = `
        <span class="rail-badge-indicator" aria-hidden="true">🟢</span>
        <span class="rail-badge-text">On Time</span>
        <span class="rail-badge-reload-icon" title="Refresh live status">↻</span>
      `;
      ...
      badge.innerHTML = `
        <span class="rail-badge-indicator" aria-hidden="true">⚠️</span>
        <span class="rail-badge-text">Retry</span>
        <span class="rail-badge-reload-icon" title="Retry live status">↻</span>
      `;
